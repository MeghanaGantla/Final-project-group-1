...
tokenize = DistilBertTokenizer.from_pretrained(check, do_lower_case=True)
...
model = DistilBertForSequenceClassification.from_pretrained(check, num_labels=num_labels, output_hidden_states=False,
